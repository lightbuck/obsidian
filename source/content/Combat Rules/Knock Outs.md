...
## Crawling
The Player Character is reduced to a state in which they can't fight, but they still cling to consciousness. They recover one HP and may take a move action with only their base speed. A party member may choose to spend 2 AP to help them recover if they are adjacent to them. If the Crawling PC is not helped this way in three turns they will Faint. This state can only happen once per combat (**not** once per character per combat. Only **once** per combat).